<script>
  ...
  const getAllFoods = async (e) => {
    const uid = auth.currentUser.uid;
    const response = await getAllFoodsInFoods(uid).then((data) => {
      console.log(data);
      existingFoods = data;
    });
  };
  ...
  const searchInAllFoods = () => {
    ...
    if (searchTerm) {
      const allFoods = [
        ...
        ...existingFoods.lunch,
        ...existingFoods.dinner,
        ...existingFoods.snacks,
      ];
        ...
        {#if !searchPressed}
          <div class="existing-foods">
            <div class="breakfast mini-content">
              <button
                class="show-food-btn"
                on:click={() => (showBreakfast = !showBreakfast)}
              >
            ...
            <div class="dinner mini-content">
              <button
                class="show-food-btn"
                on:click={() => (showDinner = !showDinner)}
              >
            ...
            <div class="snacks mini-content">
              <button
                class="show-food-btn"
                on:click={() => (showSnacks = !showSnacks)}
              >
