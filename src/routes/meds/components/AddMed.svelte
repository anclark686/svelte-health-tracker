...
<div class="add-med-container">
    <form action="submit" class="add-med-form" on:submit|preventDefault={submitAndClearForm}>
        <Modal bind:showModal buttonConfig={buttonConfig}>
            ...
            <div class="form-content">
              {#if edit && selectedMed}
                ...
                <input type="text" id="name" name="name" class="form-input" value={selectedMed?.name}/>

                <label for="dose" class="form-label">Dose</label>
                <input type="text" id="dose" name="dose" class="form-input" value={selectedMed?.dose}/>

                <label for="time" class="form-label">Time</label>
                <div class="times">
                    <button class="form-input times-btn" type="button" on:click={() => showTimes = !showTimes}>
                      {selectedMed?.times.map((t) => capitalize(t)).join(", ")}
                    </button>
                    <div class="time-options" style={showTimes ? "display:flex" : "display:none"}>
                    <ul class="times-menu">
                        <li>
                            <label>
                                <input 
                ...
                <input type="text" id="prescriber" name="prescriber" class="form-input" value={selectedMed?.prescriber}/>

                <label for="for" class="form-label">Taken For</label>
                <input type="text" id="for" name="for" class="form-input" value={selectedMed?.for}/>

                <label for="lastFilled" class="form-label">Last Filled</label>
                <input type="date" id="lastFilled" name="lastFilled" class="form-input" value={selectedMed?.lastFilled}/>
              {:else}
              <label for="name" class="form-label">Name</label>
              ...
              <div class="times">
                  ...
                  <ul class="times-menu">
                      <li>
                          <label>
                              <input type="checkbox" value="morning" on:change={(e) => addTime(e, "morning")}>
                              Morning
                          </label>
                      </li>
                      <li>
                          <label>
                              <input type="checkbox" value="afternoon" on:change={(e) => addTime(e, "afternoon")}>
                              Afternoon
                          </label>
                      </li>
                    </ul>
                    <ul class="times-menu">
                      <li>
                        <label>
                            <input type="checkbox" value="evening" on:change={(e) => addTime(e, "evening")}>
                            Evening
                        </label>
                    </li>
                      <li>
                          <label>
                              <input type="checkbox" value="night" on:change={(e) => addTime(e, "night")}>
                              Night
                          </label>
                      </li>
                  </ul>
              ...
              <label for="prescriber" class="form-label">Prescriber</label>
              <input type="text" id="prescriber" name="prescriber" class="form-input" />

              <label for="for" class="form-label">Taken For</label>
              <input type="text" id="for" name="for" class="form-input" />

              <label for="lastFilled" class="form-label">Last Filled</label>
              <input type="date" id="lastFilled" name="lastFilled" class="form-input" />
              {/if}
            </div>
        </Modal>
    </form>
